...
#define CONFIG_PATH "JazleDS.json"
#define SCORE_PATH "JazleDS.txt"
#define MUSIC_PATH "JazleDS.msl"
...
constexpr std::string_view
	...
	notWordMessage = "Not a library",
	creditStr = "Jazle DS\nby oliverradwell, Pk11 & NightScript";
